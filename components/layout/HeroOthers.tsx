...
const HeroOthers = () => {
    return (
        <section className="mx-3 opacity-0 animate-[fadeUp_1s_ease-out_forwards] h-[688px] lg:h-[606px] relative flex items-center flex-col justify-center lg:mx-6 relative overflow-hidden mb-3 bg-[#6B6AFD] px-3 rounded-3xl">
            ...
            <h2 className={`text-2xl font-semibold ${poppins.className} lg:text-[48px] text-white text-center`}>About GiftedForge</h2>
            <p className="text-sm font-medium text-white text-center pt-4 lg:text-base lg:max-w-[690px] leading-[24px] max-w-[345px]">Welcome to the future of freelancing. GiftedForge combines advanced AI protection, instant payments, and a modern, futuristic design to create a secure and seamless experience for freelancers and clients worldwide.</p>
