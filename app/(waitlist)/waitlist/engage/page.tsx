...
import { BsArrowLeft, BsArrowRepeat, BsExclamationCircleFill } from "react-icons/bs"
  ...
  return (
    <div className="min-h-screen bg-white px-6 pt-10 pb-12 max-w-md mx-auto">
      ...
      <p className="text-[#888] text-sm leading-relaxed mb-8">
        Interact with our latest post and be part of the momentum. Every share helps us grow.
      </p>
      ...
      <div className="bg-[#F5F5FF] rounded-3xl p-6 mb-5 flex flex-col items-center">
        <div className="w-16 h-16 rounded-full bg-[#E8E8FF] flex items-center justify-center mb-4">
          <BsArrowRepeat className="w-9 h-9 text-[#6B6AFD]" />
        </div>
        <h3 className="text-lg font-bold text-[#0E0636] mb-1">Engage on X</h3>
        <p className="text-sm text-[#888] text-center mb-5">
          Like, comment, and repost our pinned announcement
        </p>
        <a
      ...
      <div className="bg-[#F5F5FF] rounded-3xl p-5 mb-8">
        ...
        <ol className="space-y-2 text-sm text-[#555] leading-relaxed">
          <li>1- Click the button above to open our latest post on X.</li>
          <li>2- Like, leave a comment, and repost it.</li>
          <li>3- Come back here and tap &apos;I&apos;ve Engaged&apos; to confirm.</li>
        </ol>
      </div>
